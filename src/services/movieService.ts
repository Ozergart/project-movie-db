...
const movieService = {
    ...
    byGenres:(page:number = 1,sort_by:string , with_genres?:string,without_genres?:string):IRes<IMovie>=>apiService.get(urls.movies.base, {params:{page:`${page}`,'language':'uk',with_genres:with_genres,without_genres:without_genres,sort_by:sort_by}}),
